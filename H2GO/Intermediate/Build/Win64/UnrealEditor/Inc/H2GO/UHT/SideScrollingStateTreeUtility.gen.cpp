...
#include "H2GO/Variant_SideScrolling/AI/SideScrollingStateTreeUtility.h"
...
H2GO_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData();
H2GO_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerTask();
...
class UScriptStruct* FStateTreeGetPlayerInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData, (UObject*)Z_Construct_UPackage__Script_H2GO(), TEXT("StateTreeGetPlayerInstanceData"));
	}
...
class UScriptStruct* FStateTreeGetPlayerTask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerTask, (UObject*)Z_Construct_UPackage__Script_H2GO(), TEXT("StateTreeGetPlayerTask"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_H2GO_Source_H2GO_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_H2GO_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FStateTreeGetPlayerInstanceData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics::NewStructOps, TEXT("StateTreeGetPlayerInstanceData"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerInstanceData), 2160115011U) },
		{ FStateTreeGetPlayerTask::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerTask_Statics::NewStructOps, TEXT("StateTreeGetPlayerTask"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerTask), 757245359U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_H2GO_Source_H2GO_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_H2GO_4140649384(TEXT("/Script/H2GO"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_H2GO_Source_H2GO_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_H2GO_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_H2GO_Source_H2GO_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_H2GO_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
